...
export default function Home() {
  return (
    <>
      <div className="mb-8">
        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Get shopping with <span className="text-blue-600 dark:text-blue-500">the world's #1</span> Ecommerce Store.</h1>
        <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Here at Tengo we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>

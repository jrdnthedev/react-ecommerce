...
export function InfoModal({ data }: InfoModalProps) {
    ...
    return (
        <div id="popup-modal" tabIndex={-1} ref={modalRef} role="dialog" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{data}</h3>
                    </div>
                </div>
            </div>
        </div>
